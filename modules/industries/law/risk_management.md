...
## Human Resources and Employment Risk
...
For questions about risk management or to report a potential risk, please contact {% if risk_contact %}{{ risk_contact }}{% else %}the Risk Management Officer{% endif %} or the Managing Partner.
